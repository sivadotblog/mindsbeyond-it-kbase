# How To: Atlas Search Custom Analyzer Tuning

**Document ID**: KB-0046  
**Category**: How-To Guide  
**Domain**: Search Tuning  
**Framework**: Diátaxis Framework  

---

## Overview
This document outlines procedure steps for **Atlas Search Custom Analyzer Tuning** in the internal Mindsbeyond Data Platform environment.
...
1. **Tooling & Access**: Enterprise Credentials for Search Tuning, Active Network Access.
...
apply_analyzer_config.py --sourceID=SRC-99402 --env=prod
```
...
```bash
echo 'Verifying Atlas Search Custom Analyzer Tuning...' && db.content.aggregate([{$search:...}])
```
...
### Common Error
**Error Message**: `Error: SearchTuningExecutionFailed`
