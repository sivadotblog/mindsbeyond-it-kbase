# How To: OpenAPI Gateway Authentication Rules
...
## Overview
This document outlines procedure steps for **OpenAPI Gateway Authentication Rules** in the internal Mindsbeyond Data Platform environment.
...
1. **Tooling & Access**: Enterprise Credentials for API Gateway, Active Network Access.
...
apim policy apply --sourceID=SRC-99402 --env=prod
```
...
```bash
echo 'Verifying OpenAPI Gateway Authentication Rules...' && curl -I https://api.mindsbeyond.com
```
...
### Common Error
**Error Message**: `Error: APIGatewayExecutionFailed`
