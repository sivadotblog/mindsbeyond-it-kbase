# How To: Atlas Hybrid Search Querying
...
## Overview
This document outlines procedure steps for **Atlas Hybrid Search Querying** in the internal Mindsbeyond Data Platform environment.
...
hybrid_search.py --sourceID=SRC-99402 --env=prod
```
...
```bash
echo 'Verifying Atlas Hybrid Search Querying...' && db.content.aggregate([{$search:...}])
```
...
### Common Error
**Error Message**: `Error: AI&SearchExecutionFailed`
